...
int main()
{
    ...
    int frameWidth = 32;
    int frameHeight = 32;
    int coordenadasX=32*23+32*0;
    int coordenadasY=32*67;
    int casilla=32;
    ...
    while (window.isOpen())
    {
        ...
        if (clock.getElapsedTime().asSeconds() >= frameTime)
        {
            ...
            sprite.setTextureRect(sf::IntRect((currentFrame * frameWidth)+frameWidth*23, frameHeight*67, frameWidth, frameHeight));
